...
function validarFormulario() {
  ...
  if (contacto == "" || contacto == null) {
    cambiarColor("contacto");
    // mostramos le mensaje de alerta
    mostraAlerta("Campo obligatorio");
    return false;
  } else {
    var expresion = /^[,\\.\\0-9ñÑáéíóúÁÉÍÓÚ ]*$/;
    if (!expresion.test(contacto)) {
      // mostrara el mesaje que debe ingresar un nombre válido
      cambiarColor("contacto");
      mostraAlerta("No se permiten caracteres especiales ni letras");
      return false;
    }
  }
