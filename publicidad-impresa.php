...
<head>
    ...
    <title>Litografía S&T - Publicidad Impresa</title>
    ...
    echo $filas['nombre'], " ", $filas['apellido'];
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">PUBLICIDAD IMPRESA</h1>
                    </div>

                    <hr class="linea2">

                    <p style="text-align: justify;">Somos una <b>Litografía</b> donde prestamos un excelente servicio para los clientes de Medellín, nuestros principal objetivo fundamental es implementar nuestros conocimientos cada día mas.</p>

                    <p style="text-align: justify;"><b>LitografíaS&T</b> de Medellín se especializa en brindar una seguridad cómoda y con muchos factores positivos que son elementos esenciales para que su confianza como cliente sea una manera de hacernos saber que somos un proveedor eficaz.</p>

                    <p style="text-align: justify;">La <b>Publicidad Impresa</b> es la mejor opción, las <b>láminas públicitarias</b> estan ¡al alcance de tús manos!, como sabemos vivimos en una era en donde la mayoría de la información esta digitalizada, por lo tanto ofrecemos una gran variedad de precios económicos que no afectaran tú bolsillo.</p>

                    <p style="text-align: justify;">Somos especialistas en implementar colores y texturas firmes con la posibilidad de la variación de diseños que ayudaran a cualquier marca a definir su entorno.</p>

                    <p style="text-align: justify;">Nosotros en <b>LitografíaS&T</b> te ofrecemos una gama de opciones a convenir ¡conforme a la necesidad del cliente!.</p>

                    <p style="text-align: justify;">La <b>publicidad impresa</b> que te ofrecemos es real y tangible, somos expertos en mostrarte las mejores soluciones para que tú publicidad sea un exito, con la tecnología digital y moderna.</p>

                    <p style="text-align: justify;">Nuestra función se enfoca en: <b>Etiquetas, impresión de calendarios, tarjetas, volantes, pendones</b> y entre otros productos importantes para que tu publicidad tenga las mejores maneras posibles de ser implementada dentro de la sociedad con el fin de hacerse notar.

                    <div class="galeria"><br>
        <div class="contenedor-imagenes">
            <div class="imagen">
                <img src="img/nuestros-productos/publicidad-impresa/volantes.jpg" alt="">
                <div class="overlay">
                    <a href="volantes.php"><h2>Volantes</h2></a>
                </div>
            </div>
            <div class="imagen">
                <img src="img/nuestros-productos/publicidad-impresa/calendario-almanaque.jpg" alt="">
                <div class="overlay">
                    <a href="almanaques-calendarios.php"><h2>Almanaques Calendarios</h2></a>
                </div>
            </div>
            <div class="imagen">
                <img src="img/nuestros-productos/publicidad-impresa/tarjetas.jpg" alt="">
                <div class="overlay">
                    <a href="#"><h2>Tarjetas</h2></a>
                </div>
            </div>
            <div class="imagen">
                <img src="img/nuestros-productos/publicidad-impresa/etiquetas.jpg" alt="">
                <div class="overlay">
                    <a href="#"><h2>Etiquetas</h2></a>
                </div>
            </div>
        </div>
        <br>
        <center><hr class="linea3"></center>
    </div>

    <p style="text-align: justify; text-align: center;">TODOS NUETROS TRABAJOS SON ELABORADOS CON ALTOS ESTANDARES DE CALIDAD LO QUE NOS PERMITE GARANTIZARLOS.<br>
    <b>CUMPLIMIENTO & ECONOMÍA.</b></p>

    <p style="text-align: center;"><i><b>"Hoy mejor que ayer, mañana mejor que hoy".</b> Conozca nuestros servicios... Contactenos ahora!.</i></p>
