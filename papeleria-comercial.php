...
<head>
    ...
    <title>Litografía S&T - Papeleria Comercial</title>
    ...
    echo $filas['nombre'], " ", $filas['apellido'];
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">PAPELERIA COMERCIAL Y DE OFICINA</h1>
                    </div>

                    <hr class="linea2">

                    <p style="text-align: justify;">PAPELERÍA COMERCIAL Y DE OFICINA MEDELLÍN, ENCUENTRA ARTÍCULOS RELATIVOS AL PAPEL ASI COMO TODO TIPO DE COMPLEMENTOS DE OFICINA Y DE COMERCIO, COMO POR EJEMPLO
                    <b>TALONARIOS, HOJAS MEMBRETE, CARPETAS PUBLICITARIAS, AGENDAS Y TACOS DE PAPEL</b>, PERSONALIZACION A SU GUSTO.</p>

                    <div class="galeria">
                        <div class="linea"></div>
                            <div class="contenedor-imagenes">
                                <div class="imagen">
                                <img src="img/nuestros-productos/papeleria-comercial/talonario.jpg" alt="">
                                    <div class="overlay">
                                    <a href="talonarios.php"><h2>Talonarios</h2></a>
                                    </div>
                                </div>
                                <div class="imagen">
                                    <img src="img/nuestros-productos/papeleria-comercial/agenda.jpg" alt="">
                                        <div class="overlay">
                                        <a href="#"><h2>Agendas Personalizadas</h2></a>
                                        </div>
                                </div>
                                <div class="imagen">
                                    <img src="img/nuestros-productos/papeleria-comercial/tacos-de-papel.jpg" alt="">
                                        <div class="overlay">
                                            <a href="#"><h2>Tacos de Papel</h2></a>
                                        </div>
                                </div>
                                <div class="imagen">
                                    <img src="img/nuestros-productos/papeleria-comercial/hoja-membrete.jpg" alt="">
                                        <div class="overlay">
                                            <a href="#"><h2>Hojas Membrete</h2></a>
                                        </div>
                                </div>
                                <div class="imagen">
                                    <a><img src="img/nuestros-productos/papeleria-comercial/carpeta-personalizable.jpg" alt=""></a>
                                        <div class="overlay">
                                            <a href="#"><h2>Carpetas Personalizadas</h2></a>
                                        </div>
                                </div>
                            </div>
                            <br>
