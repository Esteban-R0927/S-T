...
<head>
    ...
    <title>Litografía S&T - Talonarios</title>
    ...
    echo $filas['nombre'], " ", $filas['apellido'];
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">TALONARIOS</h1>
                    </div>

                    <hr class="linea2">

                    <p style="text-align: justify;">TENEMOS UN AMPLIO CATÁLOGO DE TALONARIOS IMPRESOS QUE SON VITALES PARA EL FUNCIONAMIENTO ADMINISTRATIVO Y COMERCIAL DE SU EMPRESA O NEGOCIO.</p>
                    ...
                    <div class="row mx-5">
                        <div class="col">
                            <div class="card" style="width: 18rem;">
                                <img src="img/nuestros-productos/papeleria-comercial/talonarios/factura.jpg" class="card-img-top" alt="Imagen de tarjeta">
                                    <div class="card-body">
                                    <h4 class="card-text text-center">Facturas</h4>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem;">
                                <img src="img/nuestros-productos/papeleria-comercial/talonarios/boleta.jpg" class="card-img-top" alt="Imagen de tarjeta">
                                    <div class="card-body">
                                    <h4 class="card-text text-center">Boletas</h4>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem;">
                                <img src="img/nuestros-productos/papeleria-comercial/talonarios/orden-compra.jpg" class="card-img-top" alt="Imagen de tarjeta">
                                    <div class="card-body">
                                    <h4 class="card-text text-center">Orden de Pedido</h4>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col" align="center"><br>
                            <div class="card" style="width: 18rem;">
                                <img src="img/nuestros-productos/papeleria-comercial/talonarios/comprobante-de-ingresos.jpg" class="card-img-top" alt="Imagen de tarjeta">
                                    <div class="card-body">
                                    <h4 class="card-text text-center">Comprobante</h4>
                                    </div>
                            </div>
                        </div>
                    </div>
