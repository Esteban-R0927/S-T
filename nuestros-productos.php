...
<head>
    ...
    <title>Litografía S&T - Nuestros Productos</title>
    ...
    echo $filas['nombre'], " ", $filas['apellido'];
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">NUESTROS PRODUCTOS</h1>
                    </div>

                    <div class="galeria">
                        <div class="contenedor-imagenes">
                            <div class="imagen">
                                <img src="img/nuestros-productos/publicidad-impresa.jpg" alt="">
                                    <div class="overlay">
                                        <a href="publicidad-impresa.php">
                                            <h2>Publicidad Impresa</h2>
                                        </a>
                                    </div>
                            </div>
                            <div class="imagen">
                                <img src="img/nuestros-productos/papeleria-comercial.jpg" alt="">
                                    <div class="overlay">
                                        <a href="papeleria-comercial.php">
                                            <h2>Papelería Comercial</h2>
                                        </a>
                                    </div>
                            </div>
                            <div class="imagen">
                                <img src="img/nuestros-productos/souvenirs-publicitarios.jpg" alt="">
                                    <div class="overlay">
                                        <a href="#">
                                            <h2>Souvenirs Publicitarios</h2>
                                        </a>
                                    </div>
                            </div>
                            <div class="imagen">
                                <img src="img/nuestros-productos/impresión-a-gran-formato.jpg" alt="">
                                    <div class="overlay">
                                        <a href="">
                            ...
                            <div class="imagen">
                                <img src="img/nuestros-productos/publicidad-exterior.jpg" alt="">
                                    <div class="overlay">
                                        <a href="">
