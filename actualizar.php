...
<head>
    ...
    <title>Litografía S&T - Actualizar</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                ?>
                            <tr>
                                <th><input type="hidden" name="id" class="border text-center" value="<?php echo $filas2['id']; ?>"></th>
                                <th><input type="text" size="10" name="nombre" class="border text-center" value="<?php echo $filas2['nombre']; ?>"></th>
                                <td><input type="text" size="10" name="apellido" class="border text-center" value="<?php echo $filas2['apellido']; ?>"></td>
                                <td><input type="text" size="30" name="correo" class="border text-center" value="<?php echo $filas2['correo']; ?>"></td>
                                <td><input type="text" size="10" name="telefono_celular" class="border text-center" value="<?php echo $filas2['telefono_celular']; ?>"></td>
                                <td><input type="submit" value="ACTUALIZAR" class="btn btn-sm btn-success"></td>
                            </tr>
                            <?php }
                ?>
                        </tbody>
