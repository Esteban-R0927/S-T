...
<head>
    ...
    <title>Litografía S&T - Volantes</title>
    ...
    echo $filas['nombre'], " ", $filas['apellido'];
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">VOLANTES</h1>
                    </div>

                    <div class="row mx-5">
                        <div class="col">
                            <div class="card" style="width: 18rem;">
                                <img src="img/nuestros-productos/publicidad-impresa/volantes/volante-1.jpg" class="card-img-top" alt="Imagen de tarjeta">
                                    <div class="card-body">
                                        <h4 class="card-text text-center">Volantes</h4>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem;">
                                <img src="img/nuestros-productos/publicidad-impresa/volantes/volante-2.jpg" class="card-img-top" alt="Imagen de tarjeta">
                                <div class="card-body">
                                    <h4 style="padding-bottom: 28px;" class="card-text text-center">Volantes</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card" style="width: 18rem;">
                                <img src="img/nuestros-productos/publicidad-impresa/volantes/volante-3.jpg" class="card-img-top" alt="Imagen de tarjeta">
                                    <div class="card-body">
                                        <h4 class="card-text text-center">Volantes</h4>
                                    </div>
                            </div>
                        ...
                        <div class="col" align="center"><br>
                            <div class="card" style="width: 18rem;">
                                <img src="img/nuestros-productos/publicidad-impresa/volantes/volante-4.jpg" class="card-img-top" alt="Imagen de tarjeta">
                                    <div class="card-body">
                                        <h4 class="card-text text-center">Volantes</h4>
                                    </div>
                            </div>
