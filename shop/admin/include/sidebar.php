...
$t1="23:59:59";
$to=date('Y-m-d')." ".$t1;
 $result = mysqli_query($con,"SELECT * FROM ordenes where fecha_orden Between '$from' and '$to'");
...
?>
									...
									<li>
										...
										<?php	
	$status='Delivered';									 
$ret = mysqli_query($con,"SELECT * FROM ordenes where estado_pedido!='$status' || estado_pedido is null ");
...
<?php } ?>
								...
								<?php	
	$status='Delivered';									 
$rt = mysqli_query($con,"SELECT * FROM ordenes where estado_pedido='$status'");
