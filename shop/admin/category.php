...
$sql=mysqli_query($con,"insert into categorias(nombre_categoria,descripcion_categoria) values('$nombre_categoria','$descripcion_categoria')");
...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from categorias where id = '".$_GET['id']."'");
...
<div class="controls">
<input type="text" placeholder="Ingrese nombre de categoria"  name="nombre_categoria" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
											...
											<div class="controls">
												<textarea class="span8" name="descripcion_categoria" rows="5"></textarea>
											</div>
										</div>
...
?>									
										<tr>
											...
											<td><?php echo htmlentities($row['descripcion_categoria']);?></td>
