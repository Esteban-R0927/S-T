...
<?php $query=mysqli_query($con,"select productos.producto_image1 as pimg1,productos.nombre_producto as pname,productos.id as proid,ordenes.producto_id as opid,ordenes.cantidad as qty,productos.precio_producto as pprice,productos.costo_envio as shippingcharge,ordenes.metodo_pago as metodo_pago,ordenes.fecha_orden as odate,ordenes.id as orderid from ordenes join productos on ordenes.producto_id=productos.id where ordenes.usuario_id='".$_SESSION['id']."' and ordenes.metodo_pago is not null");
$cnt=1;
...
?>
				<tr>
					...
					<td class="cart-product-sub-total"><?php echo $row['metodo_pago']; ?>  </td>
