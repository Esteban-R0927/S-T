...
if(isset($_GET['del']))
{
$query=mysqli_query($con,"delete from lista_de_deseos where id='$wid'");
}


if(isset($_GET['action']) && $_GET['action']=="add"){
	$id=intval($_GET['id']);
	$query=mysqli_query($con,"delete from lista_de_deseos where producto_id='$id'");
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tbody>
<?php
$ret=mysqli_query($con,"select productos.nombre_producto as pname,productos.nombre_producto as proid,productos.producto_image1 as pimage,productos.precio_producto as pprice,lista_de_deseos.producto_id as pid,lista_de_deseos.id as wid from lista_de_deseos join productos on productos.id=lista_de_deseos.producto_id where lista_de_deseos.usuario_id='".$_SESSION['id']."'");
